...
| Agent | 파일 | 역할 |
|-------|------|------|
| `codebase-explorer` | `agents/codebase-explorer.md` | 기존 코드베이스 분석, 패턴/제약사항 파악 |
| `docs-researcher` | `agents/docs-researcher.md` | 공식 문서, 가이드, best practices 리서치 |
| `tradeoff-analyzer` | `agents/tradeoff-analyzer.md` | 옵션별 pros/cons 정리, 비교 분석 |
| `decision-synthesizer` | `agents/decision-synthesizer.md` | 두괄식 최종 보고서 생성 |
