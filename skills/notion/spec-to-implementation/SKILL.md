...
description: Turns product or tech specs into concrete Notion tasks that Claude code can implement. Breaks down spec pages into detailed implementation plans with clear tasks, acceptance criteria, and progress tracking. Trigger on "스펙 구현", "태스크 분해", "구현 계획". For meeting prep use meeting-intelligence; for saving knowledge use knowledge-capture; for research reports use research-documentation.
---
